...
public class CompraSteps {
	...
	public void seleciono_um_produto_desejado() throws Throwable {
		...
		driver.findElement(By.xpath("//*['product-buy-button']/a")).click();
	...
	public void a_opcao_de_boleto_bancario_e_exibido_com_sucesso() throws Throwable {
		WebElement boleto = driver.findElement(By.id("payment-group-bankInvoicePaymentGroup"));
		Assert.assertEquals(true, boleto.isDisplayed());
